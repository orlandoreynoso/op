<?php
  ...
  <?php
  /* nombre del label */
  $obj = get_post_type_object( 'mision' );
  $nombrept = $obj->labels->singular_name;

  /*  muesetra el slug */
  $post_type_obj = get_post_type_object('mision');
    ...
    <div class="row">
      <div class="thumb col-md-6">
        <a href="<?php echo esc_url( home_url( '/' ) ).$slug; ?>">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/mision.jpg" alt="<?php echo $nombrept; ?>">
        </a>
      </div>
